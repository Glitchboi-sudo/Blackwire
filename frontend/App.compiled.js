...
.int-pos-tag{display:inline-flex;align-items:center;gap:4px;font-size:10px;padding:2px 8px;background:var(--bg3);border:1px solid var(--brd);border-radius:4px;color:var(--orange);font-family:var(--font-mono)}
      ...
      , React.createElement('main', { className: "main",}
        ...
        , curPrj && (() => {
          ...
          else if (_optionalChain([activeExt, 'access', _58 => _58.ui_schema, 'optionalAccess', _59 => _59.type]) === 'schema-driven') {
      ...
      , contextMenu && (
        React.createElement('div', { ref: ctxMenuRef, className: "context-menu", style: { left: contextMenu.x, top: contextMenu.y }, onClick: e => e.stopPropagation(),}
          , (() => {
            const hasBody = _optionalChain([contextMenu, 'access', _60 => _60.normalized, 'optionalAccess', _61 => _61.body]) || _optionalChain([contextMenu, 'access', _62 => _62.request, 'optionalAccess', _63 => _63.response_body]) || contextMenu.source === 'selection';
            const hasUrl = _optionalChain([contextMenu, 'access', _64 => _64.normalized, 'optionalAccess', _65 => _65.url]);
            const isSelection = contextMenu.source === 'selection';
            const currentTab = contextMenu.currentTab;
            const hasRequest = _optionalChain([contextMenu, 'access', _66 => _66.normalized, 'optionalAccess', _67 => _67.method]) && _optionalChain([contextMenu, 'access', _68 => _68.normalized, 'optionalAccess', _69 => _69.url]);
